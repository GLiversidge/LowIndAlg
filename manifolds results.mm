isomorphism classes of Torsion free subgroups of Coxeter groups
...
l:=3;m:=3;n:=6;
    ...
    Order(G);
    0
    SGOrders;//orders of torsion groups
...
l:=3;m:=4;n:=4;
    ...
    //subgroups of index 2..12 (cumulative)
     T1:=
        [
    ...
    //normal subgroups of index 2..12 (non-cumulative)
     T2;
    [
...
l:=3;m:=5;n:=3;
    ...
    //subgroups of index 2..6 (cumulative)
     T1:=
    [
        [ 1, 1, 1, 1, 1, 1 ],
        [ 2, 1, 1, 1, 2, 2 ],
    ...
    //normal subgroups of index 2..6 (non-cumulative)
    T2:=
    [
        [ 1, 0, 0, 0, 0, 4 ],
        [ 2, 0, 0, 0, 5, 8 ],
...
l:=3;m:=6;n:=3;
    ...
    [
     ...
     T1;//subgroups of index 2..6 (cumulative)
    [
        [ 1, 4, 5, 8, 9, 13 ],
        [ 2, 4, 5, 8, 9, 13 ]
    ]
     T2;//normal subgroups of index 2..6 (non-cumulative)
    [
        [ 1, 3, 2, 7, 4, 18 ],
        [ 2, 3, 2, 7, 4, 18 ]
    ]
...
l:=4;m:=3;n:=5;
    ...
    //L2 gives rewrites of subgroups in L
    L2:=[
    ...
    T3;//subgroups of index 2..5 (not cumulative)
    [
        [ 1, 3, 4, 13, 7 ],
        [ 2, 7, 5, 36, 10 ],
        [ 3, 7, 1, 24, 10 ],
...
l:=4;m:=3;n:=6;
    ...
    //L2 contains rewrites of subgroups in L
    L2:=[
...
l:=5;m:=3;n:=5;
    ...
    L3;//rewrites by inbuilt function
        [
            Finitely presented group on 3 generators
            Generators as words in group G
                $.1 = d * c * b * a
                $.2 = b * c * d * c * b * c * d * b * a * b
                $.3 = a * b * a * b * d * c * b * d * c * a * b * a * b * a
            Relations
                $.1^2 * $.3^-1 * $.1 * $.3^-2 * $.1^-2 * $.2 * $.3^-2 * $.1 * $.3^-1 *
                $.2^-2 = Id($)
                $.1^2 * $.3 * $.2^-2 * $.1^-1 * $.2^-1 * $.3^-2 * $.1^-2 * $.2^-1 *
                $.1^-1 * $.2^-2 = Id($)
                $.1^-1 * $.2^-1 * $.1^-1 * $.3 * $.1^-1 * $.3^2 * $.2 * $.1 * $.2^2 *
                $.3^-2 * $.1 * $.3^-1 * $.2^-2 = Id($),

            Finitely presented group on 3 generators
            Generators as words in group G
                $.1 = d * c * b * a
                $.2 = b * a * c * b * d * c * d * c * b * a * b * a
                $.3 = b * c * d * c * b * a * d * b * c * b * a * b
            Relations
                $.1^-1 * $.2^-1 * $.3^-1 * $.1^2 * $.2^-1 * $.1^3 * $.2^-1 * $.3 *
                $.1^-1 * $.2^-1 * $.3^-1 * $.2 * $.3^-1 * $.2 * $.1^-3 * $.3 = Id($)
                $.2 * $.1 * $.3^-1 * $.2 * $.1^-3 * $.2 * $.1^-2 * $.2 * $.3^-1 * $.2 *
                $.1^-3 * $.3 * $.1^-1 * $.2 * $.1^-2 * $.3 * $.2 = Id($)
                $.1^2 * $.2^-1 * $.3 * $.1^-3 * $.3 * $.2 * $.3^-1 * $.2 * $.1^-3 * $.3
                * $.2 * $.3^-1 * $.2 * $.1^-3 * $.3 * $.1^2 * $.2^-1 * $.1 = Id($),

            Finitely presented group on 3 generators
            Generators as words in group G
                $.1 = d * c * b * a
                $.2 = b * c * b * d * c * b * a * b * c * a
                $.3 = c * b * a * b * a * c * b * d * c * d * b * a * b * a
            Relations
                $.1^-1 * $.3^-1 * $.2 * $.3 * $.1^-1 * $.3^-1 * $.2 * $.3 * $.1^-2 * $.3
                * $.1^-2 * $.2 * $.1^-1 * $.2 * $.1^-1 * $.3^-1 * $.2^-1 = Id($)
                $.1 * $.2^-1 * $.1 * $.2^-1 * $.1^3 * $.3^-1 * $.2^-1 * $.3 * $.1^2 *
                $.2^-1 * $.1 * $.3 * $.1^-2 * $.2 * $.1^-1 * $.2 * $.1^-1 * $.3^-1 *
                $.2^-1 * $.3 = Id($)
                $.2^-1 * $.1^2 * $.3^-1 * $.2^-1 * $.3 * $.1^-2 * $.2 * $.1^-1 * $.2 *
                $.1^-1 * $.3^-1 * $.1^-1 * $.3^-1 * $.2 * $.3 * $.1 * $.2^-1 * $.1 *
                $.2^-1 * $.1^2 * $.3^-1 = Id($),

            Finitely presented group on 3 generators
            Generators as words in group G
                $.1 = d * c * b * a
                $.2 = b * c * b * a * b * d * c * d * c * a
                $.3 = c * b * a * b * d * c * b * a * b * c * d * a * b * a
            Relations
                $.1 * $.2 * $.1 * $.3^-1 * $.2 * $.1 * $.3^-1 * $.2 * $.1^-1 * $.2 *
                $.1^-1 * $.2 * $.3 * $.1 * $.2 * $.1^2 * $.2 * $.3 = Id($)
                $.2 * $.3 * $.1^-2 * $.2^-1 * $.1^-1 * $.3^-1 * $.2^-1 * $.1 * $.2^-1 *
                $.3 * $.1^-2 * $.2^-1 * $.1^-1 * $.3^-1 * $.1^-1 * $.2 * $.3 * $.1 * $.2
                * $.1^2 = Id($)
                $.2 * $.1^-1 * $.2 * $.3 * $.1 * $.2 * $.1^3 * $.3 * $.1^-1 * $.2^-1 *
                $.1^-1 * $.3^-1 * $.2^-1 * $.1 * $.3 * $.1^-1 * $.2^-1 * $.1^-1 * $.3^-1
                * $.2^-1 * $.1 * $.3 * $.1 * $.2 = Id($),
            ...
            Generators as words in group G
                $.1 = d * c * d * c * b * a
                $.2 = b * a * d * c * d * b * c * a
                $.3 = b * c * b * d * c * d * a * b * a * b
                $.4 = b * a * b * c * b * a * b * d * c * a * b * a * b * a
            Relations
                $.1^-1 * $.2^-1 * $.3^-1 * $.2^-1 * $.1 * $.2^-1 * $.3 = Id($)
                $.4^-1 * $.3 * $.2 * $.1^2 * $.4^-2 * $.2 * $.1^-1 * $.3 = Id($)
                $.1^2 * $.4^-2 * $.3^-1 * $.2^-1 * $.1^-1 * $.2^-1 * $.3^-1 * $.4^-1 *
                $.3^-1 = Id($)
                $.3 * $.2 * $.1^2 * $.2^-1 * $.1 * $.2^-1 * $.4 * $.3^-1 * $.1^2 *
                $.4^-1 = Id($)
                $.3 * $.1^-2 * $.3 * $.4^-1 * $.2 * $.1^-1 * $.2 * $.4^-2 * $.2 * $.1^-1
                = Id($),
            ...
            Generators as words in group G
                ...
                $.3 = c * b * a * d * c * b * a * b
            Relations
                $.1^-2 * $.3 * $.1^-1 * $.2^-1 * $.3^-1 * $.2 * $.1^-1 * $.2 * $.3^-1 *
                $.2^-1 * $.1^-1 * $.3 = Id($)
                $.2 * $.1^-1 * $.2 * $.1^-1 * $.2 * $.3 * $.2 * $.1^-1 * $.2 * $.3^-1 *
                $.2^-1 * $.1^-1 * $.2^-1 * $.3^-1 * $.2 * $.1^-1 * $.2 * $.3 = Id($)
                $.2^-1 * $.1 * $.2^-1 * $.3 * $.2 * $.1 * $.2 * $.3 * $.1^-2 * $.3 *
                $.1^-2 * $.3 * $.2 * $.1 * $.2 * $.3 * $.2^-1 * $.1 * $.2^-1 = Id($),

            Finitely presented group on 3 generators
            Generators as words in group G
                $.1 = b * d * c * b * d * c * b * a
                $.2 = c * b * a * d * c * d * b * a * b * a
                $.3 = c * d * c * b * d * a * b * c * b * a * b * a
            Relations
                $.2 * $.3^-1 * $.1^-1 * $.2 * $.3^-1 * $.2 * $.1 * $.3^-1 * $.1 * $.3^-1
                * $.2^2 * $.3^-1 * $.2 * $.1 * $.2 * $.1^-1 * $.3 * $.1^-1 * $.2^-1 *
                $.3 * $.2^-1 * $.1 * $.3 * $.2^-1 * $.3 * $.1^-2 = Id($)
                $.1^-1 * $.3 * $.1^-1 * $.2^-1 * $.3 * $.2^-1 * $.1 * $.3 * $.2^-1 * $.3
                * $.1^-1 * $.2^-1 * $.1^-1 * $.2 * $.3^-1 * $.2 * $.1 * $.3^-1 * $.1^-1
                * $.2 * $.3^-1 * $.1^-1 * $.2 * $.3^-1 * $.2 * $.1 * $.3^-1 * $.1 *
                $.3^-1 * $.2^2 = Id($)
                $.3 * $.2 * $.1^-1 * $.3 * $.1^-1 * $.2^-1 * $.3 * $.2^-1 * $.1 * $.3 *
                $.2^-1 * $.3 * $.1^-2 * $.3 * $.1^-1 * $.2^-1 * $.3 * $.2^-1 * $.1 * $.3
                * $.2^-1 * $.3 * $.1^-1 * $.3 * $.1^-1 * $.2^-1 * $.3 * $.2^-1 * $.1 *
                $.3 * $.2^-1 * $.1 = Id($),
            ...
            Generators as words in group G
                $.1 = b * d * c * b * d * c * b * a
                $.2 = a * c * d * c * b * d * c * d * b * a * b * a
                $.3 = a * b * d * c * b * a * d * c * d * b * c * a * b * a
            Relations
                $.2 * $.3^-1 * $.2 * $.1^-1 * $.2 * $.3 * $.1^-1 * $.3 * $.1^-1 * $.3 *
                $.2^-1 * $.1^-1 * $.2 * $.3^-1 * $.2 * $.1^-1 * $.2 * $.3 * $.1^-1 *
                $.2^-1 * $.1 * $.3 = Id($)
                $.1 * $.3^-1 * $.2^-1 * $.1 * $.3^-1 * $.1 * $.3^-1 * $.2^-1 * $.1 *
                $.2^-1 * $.3 * $.2^-1 * $.1^-1 * $.3^-1 * $.1^-1 * $.2 * $.1 * $.3^-1 *
                $.2^-1 * $.1 * $.2^-1 * $.3 = Id($)
                $.2 * $.3^-1 * $.1 * $.3^-1 * $.2^-1 * $.1 * $.3 * $.1^-1 * $.3^-1 * $.2
                * $.1^-1 * $.2 * $.3 * $.1^-1 * $.2^-1 * $.1 * $.2 * $.1^-1 * $.2 * $.3
                * $.1^-1 * $.2^-1 * $.1 = Id($),

            Finitely presented group on 3 generators
            Generators as words in group G
                $.1 = b * d * c * b * d * c * b * a
                $.2 = a * d * c * b * d * c * b * a * b * a
                $.3 = c * d * c * d * b * a * b * c * b * a
            Relations
                $.3^2 * $.2^-1 * $.3^2 * $.1^-1 * $.2^-1 * $.1 * $.2^-1 * $.3 * $.2^-1 *
                $.1 * $.2^-1 * $.1^-1 = Id($)
                $.1 * $.3^-2 * $.2 * $.3^-1 * $.1^-1 * $.3^-1 * $.2 * $.3^-2 * $.2 *
                $.3^-1 * $.1^-1 * $.3^-1 * $.2 * $.3^-2 * $.1 * $.2 = Id($)
                $.1^-1 * $.2^-1 * $.1^-1 * $.3^2 * $.2^-1 * $.3^3 * $.2^-1 * $.3^2 *
                $.1^-1 * $.2^-1 * $.1^-1 * $.2 * $.3^-1 * $.2 * $.1^-1 * $.2 * $.3^-1 *
                $.2 = Id($),

            Finitely presented group on 3 generators
            Generators as words in group G
                $.1 = b * d * c * b * d * c * b * a
                $.2 = a * c * b * a * b * c * d * a * b * a
                $.3 = b * a * b * c * b * d * c * d * b * a
            Relations
                $.2^-1 * $.3 * $.2^-1 * $.1 * $.3^-1 * $.1 * $.2 * $.3^-1 * $.1 * $.2 *
                $.3^-1 * $.2 * $.1 * $.3 * $.2^-1 * $.1 * $.3^-1 * $.1 * $.2 * $.1^-1 *
                $.3^-1 = Id($)
                $.2^-1 * $.1 * $.3^-1 * $.1 * $.2 * $.1^-1 * $.2^-1 * $.3 * $.2^-1 *
                $.1^-1 * $.3 * $.1^-1 * $.3^-1 * $.1 * $.2 * $.3 * $.2^-1 * $.1 * $.3^-1
                * $.1 * $.2 * $.1^-1 = Id($)
                $.3 * $.1 * $.2^-1 * $.1^-1 * $.3 * $.1^-1 * $.2 * $.3^-1 * $.2^-1 *
                $.1^-1 * $.3 * $.1^-1 * $.3 * $.2^-1 * $.1^-1 * $.3 * $.1^-1 * $.2 *
                $.3^-1 * $.2 * $.1 * $.2 = Id($),

            Finitely presented group on 4 generators
            Generators as words in group G
                $.1 = b * a * c * b * d * c * d * a
                $.2 = b * c * b * a * d * c * d * c * b * a
                $.3 = b * d * c * b * d * c * d * b * c * a
                $.4 = d * c * d * c * b * a * d * b * c * d * a * b
            Relations
                $.2^-1 * $.3 * $.4 * $.1^-1 * $.2 * $.3^-1 * $.4 * $.1 * $.2^-1 * $.3^-1
                * $.4^-1 * $.1^-1 = Id($)
                $.1^-1 * $.2^-1 * $.3 * $.1^-1 * $.4^-1 * $.3 * $.1^-1 * $.4^-1 * $.3 *
                $.2^-1 * $.1 * $.4^-1 = Id($)
                $.2 * $.1^-1 * $.3 * $.4 * $.1^-1 * $.2 * $.1 * $.4 * $.3 * $.2 * $.1^-1
                * $.3 = Id($)
                $.2^-1 * $.3 * $.1^-1 * $.4^-1 * $.3 * $.2^-1 * $.1 * $.4 * $.3 * $.2 *
                $.1^-1 * $.3 * $.4 = Id($)
                $.1^-1 * $.3^2 * $.1^-1 * $.4^-1 * $.3 * $.2^-1 * $.1 * $.3 * $.1 * $.4
                * $.3 * $.2 = Id($),
            ...
            Generators as words in group G
                $.1 = (d * c * b * a)^2
                $.2 = b * c * b * a * b * d * c * d * c * a
                $.3 = a * c * b * a * b * a * d * c * d * c * b * a
                $.4 = c * b * d * c * b * a * b * c * d * c * d * a
            Relations
                $.1 * $.3^-2 * $.4 * $.1 * $.2 * $.4 * $.3^-1 * $.2 * $.4^-1 = Id($)
                $.4 * $.2^-1 * $.1^-1 * $.4^-1 * $.3 * $.1^-2 * $.4 * $.2^-1 * $.3 *
                $.2^-1 = Id($)
                $.3^2 * $.1^-1 * $.2 * $.4 * $.1 * $.3 * $.1^-1 * $.4 * $.2^-1 * $.3 *
                $.2^-1 = Id($)
                $.2^-1 * $.1^-1 * $.4^-1 * $.3 * $.1^-1 * $.3^-1 * $.2 * $.4^-1 * $.2 *
                $.3 * $.1^-2 = Id($)
                $.1 * $.3^-1 * $.2^-1 * $.4 * $.2^-1 * $.1^-1 * $.4^-1 * $.2^-1 * $.4 *
                $.2^-1 * $.3 * $.4^-1 * $.2^-1 = Id($)
        ]

     T3;//subgroups if index 2..5 (not cumulative)
    [
        [ 1, 0, 0, 0, 11 ],
        [ 2, 1, 1, 1, 9 ],
        [ 3, 0, 0, 0, 2 ],
    ...
    Homomorphism of GrpFP: H1 into GrpFP: H2 induced by
        ...
        H1.3 |--> H2.1 * H2.3^-1
    8 and 10 are isomorphic//L3 used
        true Homomorphism of GrpFP into GrpFP induced by
            $.1 |--> $.2^-1 * $.1^-1
            $.2 |--> $.2^-1
            $.3 |--> $.3^-1
        Homomorphism of GrpFP into GrpFP induced by
            $.1 |--> $.1^-1 * $.2
            $.2 |--> $.2^-1
            $.3 |--> $.3^-1
    11 and 12 are isomorphic
...
l:=5;m:=3;n:=6;
  ...
  T3;//number of subgroups (not cumulative)
    //-1 used when the number of subgroups has not been tested
    [
        [ 1, 15, 33, 402, -1, -1 ],
        [ 2, 31, -1, -1, -1, -1 ],
        [ 3, 15, 33, 400, -1, -1 ],
    ...
    AQInvariants(L2[20]);
        ...
        for i in [19, 20] do 
            l2qs:=[];
            for q in [2..11] do 
                if #Factorisation(q) eq 1 then 
                    hms:=Homomorphisms(L2[i],PSL(2,q));
                    if #hms gt 0 then 
                        Append(~l2qs,q); 
                        Append(~l2qs,#hms); 
                    end if;
        ...
        19 [ 2, 12, 3, 10, 4, 124, 5, 124, 7, 148, 8, 954, 9, 536, 11, 552 ]
        20 [ 2, 12, 3, 10, 4, 124, 5, 124, 7, 148, 8, 954, 9, 536, 11, 556 ]
...
l:=6;m:=3;n:=6;
    ...
    T3;//number of subgroups of index 2..6 (non-cumulative)
    //-1 used when subgroups not tested
    [
        [ 1, 3, 4, 15, -1, -1 ],
        [ 2, 7, 10, 47, 45, 271 ],
        [ 3, 7, 12, 81, 111, 628 ],
    ...
    2 and 9 are isomorphic
        SearchForIsomorphism(L2[2], L2[9], 10);
        true Homomorphism of GrpFP into GrpFP induced by
            $.1 |--> $.1 * $.2^-1 * $.3
            $.2 |--> $.3 * $.1
            $.3 |--> $.1^-1
    ...
    3 and 7 are isomorphic
        SearchForIsomorphism(L2[3], L2[7], 10);
        true Homomorphism of GrpFP into GrpFP induced by
            $.1 |--> $.3^-1 * $.2^-1 * $.3^-1
            $.2 |--> $.1 * $.2
            $.3 |--> $.2^-1 * $.3^-1
        Homomorphism of GrpFP into GrpFP induced by
            ...
            $.3 |--> $.3 * $.1^-1
    4 and 10 are isomorphic
        SearchForIsomorphism(L2[4], L2[10], 5);
        true Homomorphism of GrpFP into GrpFP induced by
            $.1 |--> $.1 * $.3 * $.1^-1 * $.2
            $.2 |--> $.2
        Homomorphism of GrpFP into GrpFP induced by
    ...
    6 and 11 are isomorphic
        SearchForIsomorphism(L2[6], L2[11], 10);
        true Homomorphism of GrpFP into GrpFP induced by
            $.1 |--> $.2 * $.3^-1 * $.2 * $.1^-2
            $.2 |--> $.2 * $.3^-1
            $.3 |--> $.1 * $.3 * $.2^-1
